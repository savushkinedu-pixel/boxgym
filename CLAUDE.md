...
- [ ] M5 — Полировка: онбординг, мониторинг, передача тренеру
  ...
  - TODO (тренер): /mygroup — список записанных на сегодня/завтра/неделю
  - TODO (атлет): /subscribe — массовая запись на повторяющиеся тренировки
    (например: "все вторники 09:30 и воскресенья 10:30 на месяц вперёд")
